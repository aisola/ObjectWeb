...
## license: LGPLv3
## summary: This document creates a VERY simple blogging software
##          implementation in ObjectWeb. This is NOT for production use.
...
NewPostForm = forms.Form(
    ...
    validators=[
        forms.Validator("Title is Required.",
                        lambda frm: bool(frm.title.get_value())),
        forms.Validator("Content is Required.",
                        lambda frm: bool(frm.content.get_value()))
    ]
)
